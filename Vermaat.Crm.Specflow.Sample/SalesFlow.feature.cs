...
#line hidden
            ...
            table71.AddRow(new string[] {
                        ...
                        "Qualify Account"});
#line 6
testRunner.Given("a lead named ToQualify with the following values", ((string)(null)), table71, "Given ");
#line hidden
            ...
            table72.AddRow(new string[] {
                        ...
                        "true"});
#line 12
testRunner.When("ToQualify is qualified to a", ((string)(null)), table72, "When ");
#line hidden
            ...
            table73.AddRow(new string[] {
                        ...
                        "Qualify Account"});
#line 15
testRunner.Then("an account named QualifyAccount exists with the following values", ((string)(null)), table73, "Then ");
#line hidden
            ...
            table74.AddRow(new string[] {
                        ...
                        "Test"});
#line 19
testRunner.And("a contact exists with the following values", ((string)(null)), table74, "And ");
#line hidden
            ...
            table75.AddRow(new string[] {
                        ...
                        "Qualification Test"});
#line 25
testRunner.And("an opportunity exists with the following values", ((string)(null)), table75, "And ");
#line hidden
...
#line hidden
            ...
            table76.AddRow(new string[] {
                        ...
                        "TestAccount"});
#line 32
testRunner.Given("an account named TestAccount with the following values", ((string)(null)), table76, "Given ");
#line hidden
...
testRunner.When("a related opportunity from TestAccount named TestOpp is created with the followin" +
                    "g values", ((string)(null)), table77, "When ");
#line hidden
            ...
            table78.AddRow(new string[] {
                        ...
                        "TestAccount"});
#line 39
testRunner.Then("TestOpp has the following values", ((string)(null)), table78, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table79.AddRow(new string[] {
                        ...
                        "QuoteTesting"});
#line 47
testRunner.Given("an account named QuoteTesting with the following values", ((string)(null)), table79, "Given ");
#line hidden
            ...
            table80.AddRow(new string[] {
                        ...
                        "QuoteTesting"});
#line 50
testRunner.And("a quote named TestQuote with the following values", ((string)(null)), table80, "And ");
#line 56
...
#line hidden
            ...
            table81.AddRow(new string[] {
                        ...
                        "TestQuote"});
#line 57
testRunner.Then("TestOrder has the following values", ((string)(null)), table81, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table82.AddRow(new string[] {
                        ...
                        "QuoteTesting"});
#line 66
testRunner.Given("an account named QuoteTesting with the following values", ((string)(null)), table82, "Given ");
#line hidden
            ...
            table83.AddRow(new string[] {
                        ...
                        "QuoteTesting"});
#line 69
testRunner.And("a quote named TestQuote with the following values", ((string)(null)), table83, "And ");
#line 74
...
#line hidden
            ...
            table84.AddRow(new string[] {
                        ...
                        "QuoteTesting"});
#line 76
testRunner.Then("RevisiedQuote has the following values", ((string)(null)), table84, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
