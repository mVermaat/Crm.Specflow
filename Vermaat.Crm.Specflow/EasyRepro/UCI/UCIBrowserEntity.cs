...
{
    //class UCIBrowserEntity
    //{
    //    private readonly UCIBrowser _browser;
    ...
    //    public bool IsFieldVisible(string fieldLogicalName)
    //    {
    ...
    //    public void SaveRecord(bool saveIfDuplicate)
    //    {
    //        _app.Entity.Save();
