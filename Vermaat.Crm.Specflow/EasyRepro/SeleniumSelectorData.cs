...
namespace Vermaat.Crm.Specflow.EasyRepro
{
    public class SeleniumSelectorData
    {
        private readonly Dictionary<SeleniumSelectorItems, string> _selectors = new Dictionary<SeleniumSelectorItems, string>()
        {
            ...
            { SeleniumSelectorItems.Entity_Ribbon_Button, ".//button[starts-with(@title,'[NAME]') and span/span/text() = '[NAME]']" },
            ...
            { SeleniumSelectorItems.Entity_QuickCreate_SaveAndCloseButton, "//button[contains(@id,'quickCreateSaveAndCloseBtn')]" },
